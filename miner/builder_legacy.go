...
func (w *Miner) rawCommitTransactions(env *environment, txs types.Transactions) error {
...
func (w *Miner) commitPendingTxs(work *environment) error {
	// TODO: Add timeout
...
func (w *Miner) buildBlockFromTxs(ctx context.Context, args *types.BuildBlockArgs, txs types.Transactions) (*types.Block, *big.Int, error) {
...
func (w *Miner) buildBlockFromBundles(ctx context.Context, args *types.BuildBlockArgs, bundles []types.SBundle) (*types.Block, *big.Int, error) {
